...
import random
import ShogunXRobot.modules.sql.users_sql as sql

from ShogunXRobot import (ALLOW_EXCL, CERT_PATH, DONATION_LINK, LOGGER,
                          OWNER_ID, PORT, SUPPORT_CHAT, TOKEN, URL, WEBHOOK,
                          SUPPORT_CHAT, dispatcher, StartTime, telethn, updater, pbot)
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from ShogunXRobot.modules import ALL_MODULES
from ShogunXRobot.modules.helper_funcs.chat_status import is_user_admin
from ShogunXRobot.modules.helper_funcs.misc import paginate_modules
from ShogunXRobot.hacking_script import PM_START_TEXT, PM_START_PIC
...
*Main* commands available:
 ...
 ➛ /settings: 
   ...
   ❂ in a group: will redirect you to pm, with all that chat's settings.\n• *Support Chat For Help:* [Nexus](https://t.me/Scythe_Support)
""".format(
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("ShogunXRobot.modules." + module_name)
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        first_name = update.effective_user.first_name
        update.effective_message.reply_photo(
                photo=(HELP_IMG), caption= "<b>Behold!!! My True Self.
