...
import ShogunXRobot.modules.helper_funcs.fun_strings as fun
from ShogunXRobot import LOGGER, DEV_USERS, dispatcher
from ShogunXRobot.modules.disable import (
...
*Regex based memes:*
`/decide` (disabled rn) can be also used with regex like: `Raiden Shogun What? <question>: randomly answer "Yes, No" etc.`
Some other regex filters are:
`me too`.

Raiden Shogun will reply random strings accordingly when these words are used!
