...
async def lego(event):
 ...
 try:
    ...
    fillcolor = "black"
    shadowcolor = "blue"
    fnt = glob.glob("./ShogunXRobot/LOGO_FONT/*")
    ...
    fname = "fallen.png"
    img.save(fname, "png")
    await telethn.send_file(event.chat_id, file=fname, caption = f"Logo Created By @ShogunXRobot")         
    await pesan.delete()
    if os.path.exists(fname):
            os.remove(fname)
 except Exception as e:
    await event.reply(f'Floodwait Error, Report This At @Scythe_Support')


__mod_name__ = "Logo​"

__help__ = """
Raiden Shogun can create some beautiful and attractive logo for your profile pics.
