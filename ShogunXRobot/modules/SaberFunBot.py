...
from ShogunXRobot.modules.disable import MessageHandler
from telegram.ext import run_async, Filters
from telegram import Message

OWO = (
    "*Raiden  pats {} on the head.",
    "*gently rubs {}'s head*.",
    "*Raiden  mofumofus {}'s head*",
    "*Raiden  messes up {}'s head*",
    "*Raiden  intensly rubs {}'s head*",
