...
from ShogunXRobot import dispatcher  # BAN_STICKER
...
from ShogunXRobot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user_and_text,
    extract_user,
)
from ShogunXRobot.modules.helper_funcs.filters import CustomFilters
from ShogunXRobot.modules.helper_funcs.misc import split_message
from ShogunXRobot.modules.helper_funcs.string_handling import split_quotes
from ShogunXRobot.modules.log_channel import loggable
from ShogunXRobot.modules.sql import warns_sql as sql
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        "Rules", url="http://t.me/ShogunXRobot?start={}".format(chat.id)
                    )
                ]
            ]
        )
