...
import ShogunXRobot.modules.sql.welcome_sql as sql
from ShogunXRobot import (DEV_USERS, LOGGER, OWNER_ID, DRAGONS, DEMONS, TIGERS,
                          WOLVES, sw, dispatcher, JOIN_LOGGER)
from ShogunXRobot.modules.helper_funcs.chat_status import (
    is_user_ban_protected,
    user_admin,
)
from ShogunXRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from ShogunXRobot.modules.helper_funcs.msg_types import get_welcome_type
from ShogunXRobot.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from ShogunXRobot.modules.log_channel import loggable
from ShogunXRobot.modules.sql.global_bans_sql import is_user_gbanned
...
Raiden_IMG = "https://telegra.ph/file/8d393651c1544cfe17def.mp4"
Raiden = "https://telegra.ph/file/9e9e1112a16894e7998cf.jpg"
Raiden_VID = "https://telegra.ph/file/8d393651c1544cfe17def.mp4"
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                ...
                Raiden_IMG, caption= "Behold, Raiden 剣's Creator Joined Your Chat.",
                    reply_to_message_id=reply)
            ...
            # Welcome Sudos
                ...
                Raiden, caption= "Ohh, Sudo Ka Choda Joined Your Group, Kick Him!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Support
                ...
                update.effective_message.reply_photo(
                Raiden, caption= "Huh! Someone with a B Rank Hunter level just joined!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Whitelisted
                ...
                update.effective_message.reply_photo(
                Raiden, caption= "Oof! A C Rank Hunter just joined!",
                    reply_to_message_id=reply)
                continue
            ...
            # Welcome Tigers
                ...
                update.effective_message.reply_photo(
                Raiden, caption= "Oof! A D Rank Hunter just joined!",
                    reply_to_message_id=reply)
                continue
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_video(
                Raiden_VID, caption= "Oh Crap! My Creator Left..", reply_to_message_id=reply)
                return

            # Give the devs a special goodbye
            elif left_mem.id in DEV_USERS:
                update.effective_message.reply_text(
                    "See you later at the @TeamNexusX!",
                    reply_to_message_id=reply,
                )
                return
