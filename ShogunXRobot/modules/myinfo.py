...
from ShogunXRobot import telethn as bot
...
async def callback_query_handler(event):
  try:
    ...
    Raiden = "YOUR DETAILS BY Raiden 剣 \n\n"
    Raiden += f"FIRST NAME : {PRO.first_name} \n"
    Raiden += f"LAST NAME : {PRO.last_name}\n"
    Raiden += f"YOU BOT : {PRO.bot} \n"
    Raiden += f"RESTRICTED : {PRO.restricted} \n"
    Raiden += f"USER ID : {boy}\n"
    Raiden += f"USERNAME : {PRO.username}\n"
    await event.answer(Raiden, alert=True)
