    ...
    try:
        ...
        if png_sticker:
            success = context.bot.create_new_sticker_set(
                user.id,
                packname,
                f"{name}'s Pack :: @ShogunXRobot" + extra_version,
...
Credit = "This Plugin Made by Ryomen Sukuna (@Ryomen Sukuna), if you're using this code in your bot. there is no issue but don't remove this line" 
