...
from ShogunXRobot import OWNER_ID, pgram, arq
from ShogunXRobot.utils.pluginhelpers import convert_seconds_to_minutes as time_convert
from ShogunXRobot.utils.pluginhelpers import fetch
...
async def inline_help_func(__HELP__):
    ...
    buttons.add(
        InlineKeyboardButton("More Help", url=f"t.me/ShogunXRobot?start=start"),
...
async def alive_function(answers):
   ...
   # ubot_state = 'Dead' if not await app2.get_me() else 'Alive'
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/ShogunXRobot"),
        InlineKeyboardButton("Go Inline", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[Raiden  剣](https://t.me/ShogunXRobot):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
**Platform:** `{sys.platform}`
**Profiles:** [BOT](t.me/ShogunXRobot) | [OWNER](t.me/Xelcius)
"""
